...
public class JwtService {
    ...
    public String generateToken(User user, UUID organizationId) {
        return generateToken(user, organizationId, List.of());
    }

    public String generateToken(User user, UUID organizationId, List<String> actions) {
        Date now = new Date();
        ...
        if (actions != null && !actions.isEmpty()) {
            builder.claim("actions", String.join(",", actions));
        }
