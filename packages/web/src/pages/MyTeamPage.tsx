    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-semibold text-[#1A1A1A]">{teamName} Team</h2>
            <p className="text-sm text-[#8A8A8A]">{teamMembers.length} members</p>
          </div>
        </div>
      </motion.div>
      ...
      >
        <div className="bg-white border border-[#E5E4E0] rounded-[14px] p-4 text-center shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="text-sm font-medium text-[#5C5C5C]">Safe</span>
          </div>
        ...
        <div className="bg-white border border-[#E5E4E0] rounded-[14px] p-4 text-center shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="text-sm font-medium text-[#5C5C5C]">Distress</span>
          </div>
        ...
        <div className="bg-white border border-[#E5E4E0] rounded-[14px] p-4 text-center shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="text-sm font-medium text-[#5C5C5C]">Not Updated</span>
          </div>
      ...
      >
        <div className="px-5 py-4 border-b border-[#E5E4E0]">
          <h3 className="text-xl font-semibold text-[#1A1A1A]">Team Members</h3>
          <p className="text-sm text-[#8A8A8A]">Status of your {teamName} team</p>
        </div>
        <StatusTable
