...
# PROJECT_NAME     Project name for SSH key naming (default: repo folder name)
# =============================================================================
...
if [ "$CREATE_NEW" = true ]; then
  echo ""
  read -rp "Name for new key (e.g. ${PROJECT_NAME}-deploy): " keyname
  [ -z "$keyname" ] && keyname="${PROJECT_NAME}-deploy"
